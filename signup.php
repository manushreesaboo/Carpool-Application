...
$sql = "INSERT INTO login (email,uname,password,wardemail,address,phone,pincode) VALUES (?,?,?,?,?,?,?)";
		try {
         ...
         //   die($e->getMessage());}
            redirect("signup.php?error=Email-ID already registered. Please Try again.");}
  ...
  <body>	
	...
	<section class="contact-page">
        <div  class="container">
            ...
            <td><input type="phone" data-validation="length" data-validation-length="min6" name="pincode"></td></tr>
